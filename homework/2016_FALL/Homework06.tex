...
\begin{center}
	\fbox{\fbox{\parbox{5.5in}{\centering
				This homework is due on \textbf{November 14} by \textbf{2:15PM}. You must turn in your work on a printed copy of this document in order for it to be graded. Your assignment must be stapled and in the correct order. Non-stapled assignments will automatically receive a 10 point deduction. There are a total of 50 available points.}}}
\end{center}
...
\[MP_E = \frac{2}{(E_M + E_F)^{1/2}}\]}
	...
	\part[5] How many workers does this firm hire? How much profit does it earn?
		...
		Profit:
		\[\Pi = pq - w_FE_F = \$30(9.6) - \$25(5.76) = \$144\]
	\end{solution}
	\ddp{(2) optimal employment, (2) profit, (1) work}
